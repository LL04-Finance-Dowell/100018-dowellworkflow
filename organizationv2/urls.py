...
from .views import MembersView, add_member_to_project, add_member_to_organization
...
urlpatterns = [
    ...
    path('add-member-to-project/<int:id>', login_required(add_member_to_project), name="add-member-to-project"),
    path('add-member-to-organization/<int:id>', login_required(add_member_to_organization), name="add-member-to-organization"),
