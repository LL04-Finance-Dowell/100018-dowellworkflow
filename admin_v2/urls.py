...
from .views import company_dashboard, create_company, admin_org_management,verify_user, test_email
...
urlpatterns = [
    ...
    path('test-email/', login_required(test_email), name="test-email"),
